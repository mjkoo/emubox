...
- [x] 9.5 Failure cleanup retries the claim for up to three seconds before deferring (design, accepted risks); unit tests for a claim released within the window and one held past it
